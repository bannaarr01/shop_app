...
enum AuthMode { Signup, Login } //use to switch btw Auth modes
      ...
      body: Stack(
        children: <Widget>[
          ...
          SingleChildScrollView(
            child: Container(
              //height n width to take d full device
                ...
                children: <Widget>[
                  Flexible(
                    child: Container(
                      ...
                      //allow u to rotate container / transform anyhw
                      transform: Matrix4.rotationZ(-8 * pi / 180)
                        ..translate(-10.0),
                      //z-axis from ur eyes to d fone
                      // ..translate(-10.0),
                      decoration: BoxDecoration(
...
//context is available everywhere in ds state class
